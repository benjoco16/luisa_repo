        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <p class="font-ash d-flex align-items-center w-100 font-weight-500 bold mb-0 pr-3">
                    <img src="/images/dashboard/load-balancer.svg" class="mr-2" width="14" alt=""> 
        ...
        <div class="kt-portlet__body dash-org-chart">
            <div class="row">
                        ...
                        <ul>
                            <li class="jstree-open" data-jstree='{ "icon":"fa fa-bookmark red" }'>
                                ...
                                <ul>
                                    ...
                                    <li data-jstree='{"icon":"fa fa-folder font-blue"}'> Cheapestow Lab <img src="/images/dashboard/checkmark-outline.svg" height="15" alt=""/></li>
                                    <li data-jstree='{"icon":"fa fa-folder font-blue"}'> Facilities <img src="/images/dashboard/checkmark-outline.svg" height="15" alt=""/></li>
                                    <li data-jstree='{"icon":"fa fa-folder font-blue"}'> Kings Langle Lab <span class="num">2</span></li>
                                    <li data-jstree='{"icon":"fa fa-folder font-blue"}'> Test Location <img src="/images/dashboard/checkmark-outline.svg" height="15" alt=""/></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="notice">
                        <ul>
                            <li><img src="/images/dashboard/checkmark-outline.svg" height="15" alt=""/> Fully Compliant</li>
