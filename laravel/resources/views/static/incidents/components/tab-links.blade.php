<div class="kt-portlet kt-portlet--tabs">
    ...
    <div class="kt-portlet__body p-0">                   
        <div class="tab-content">
            @include('static.incidents.components.tab-incident-details')
            @include('static.incidents.components.tab-actions')
            @include('static.incidents.components.tab-attachments')
        </div>      
    </div>
</div>