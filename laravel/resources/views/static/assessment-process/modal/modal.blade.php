    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('static.assessment-process.modal.modal-step-1')
                @include('static.assessment-process.modal.modal-step-2')
                @include('static.assessment-process.modal.modal-step-3')
                @include('static.assessment-process.modal.modal-step-4')
            </div>
        </div>
    </div>
</div>