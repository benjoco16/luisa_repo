        ...
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-header__brand " id="kt_header_brand">
                <div class="kt-header__brand-logo">
                    <a href="demo11/index.html">
                        <img alt="Logo" src="./sevron/assets/media/logos/logo-dark.png" height="50"/>
                    </a>		
                </div> 
            </div>
            <!-- end:: Brand -->		
        ...
        <div class="kt-mycart__item">
            <div class="kt-mycart__container">
                ...
                <a href="#" class="kt-mycart__pic">
                    <img src="./sevron/assets/media/products/product9.jpg" title="">
                </a>    
            </div>     			 
        </div>
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                    <a href="#" class="grad_bt">                       
                       ...
                       <!--<img src="./sevron/assets/media/dashboard/userguid.svg">-->
                    </a>
            </div>
        </div>
    </div>
